...
/**
 *
 * Bolt that will publish to a redis channel those tweets that have been
 * retweeted a number of times.
 *
 * Can be moved this bolt to any other that alread works with the tweets but,
